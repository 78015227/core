...
Feature: Share by public link
  ...
  Scenario: read only public link quick action works when enabled
    ...
    Then public link quick action button should be displayed for folder "simple-folder" on the webUI
  ...
  Scenario: read only public link quick action does not work when disabled
    ...
    And user "Alice" has logged in using the webUI
    When the user browses to the files page
    Then public link quick action button should not be displayed for folder "simple-folder" on the webUI
