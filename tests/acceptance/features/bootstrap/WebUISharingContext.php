...
class WebUISharingContext extends RawMinkContext implements Context {
	...
	/**
	 * @Then public link quick action button should be displayed for folder/file :name on the webUI
	 *
	 * @param string $name
	 *
	 * @return void
	...
	/**
	 * @Then public link quick action button should not be displayed for folder/file :name on the webUI
	 *
	 * @param string $name
	 *
	 * @return void
	 ...
	 * @throws \Exception
	 */
	public function theEmailAddressOfUserShouldHaveReceivedAnEmailContainingSharedPublicLink($user) {
